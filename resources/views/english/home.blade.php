...
@section('title', 'English Program - h!academy')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div class="space-y-6 animate-fadeInUp" data-aos="fade-up" data-aos-delay="150" data-aos-duration="800">
                    ...
                    <p class="text-gray-300 text-lg leading-relaxed">
                        At <span class="text-yellow-400 font-semibold">h!academy English</span>, we don't just teach language — 
                        we unlock global opportunities and build confidence for every learner.
                    </p>
                    <a href="{{ route('booktrial') }}"
