    ...
    <div class="bg-white rounded-xl shadow-md p-4 mb-4">
        <div class="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <!-- Create Trial -->
                <button
                    class="flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-lg font-semibold hover:bg-green-600 transition">
                ...
                <tbody>
                    @forelse ($registrations as $registration)
                        <tr class="border-b">
                            ...
                            <td class="p-3">{{ $registration->address ?? '-' }}</td>
                            <td class="p-3">
                                @php
...
<div class="bg-white rounded-xl shadow-md p-6 mt-8">
    <h2 class="font-semibold mb-4">Trial List</h2>
    <div class="overflow-x-auto">
        <table id="TrialTable" class="min-w-full border rounded-lg dataTable stripe hover">
            <thead class="bg-gray-100">
                <tr>
                    <th class="p-3 text-left">#</th>
                    <th class="p-3 text-left">Name</th>
            ...
            <tbody>
                @forelse ($trials as $registration)
                    <tr class="border-b">
                        <td class="p-3">{{ $loop->iteration }}</td>
