...
<head>
  ...
  <title>Program Details | BrainyBuddies</title>
...
<body class="bg-gray-50">
  ...
  <main class="ml-0 md:ml-[70px] lg:ml-[250px] mt-16 p-4 md:p-8">
    <div class="bg-white rounded-xl shadow-md p-8 mb-8">
      <div class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/3">
          <div class="h-64 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
            <span class="text-white text-6xl">📚</span>
          </div>
        </div>
        <div class="md:w-2/3">
          <h1 class="text-3xl font-bold mb-4">Web Development Program</h1>
          <p class="text-gray-600 mb-6">Master HTML, CSS, and JavaScript to build modern, responsive websites. This
            comprehensive program will take you from beginner to job-ready developer.</p>
          ...
          <button
            class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-lg transition-colors w-full md:w-auto">
            Continue Learning
          </button>
        </div>
      </div>
